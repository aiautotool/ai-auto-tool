...
class URL_Scanner_Plugin extends rendersetting{
    ...
    public function update_and_publish_post($post_id) {
        ...
        $message = "Publish article on Vs: ".AIAUTOTOOL_VS. ' ' .get_permalink($post_id)."\n";
        ...
        <div class="aiautotool_left">
            <div class="ft-box">
                <div class="ft-menu">
                    ...
                    <br>Add Post Planning</div>
                    <button href="#tab-schedule" class="nav-tab sotabt "> <?php echo wp_kses_post($this->icon).' '. __('Schedule AI Post','ai-auto-tool'); ?></button>
